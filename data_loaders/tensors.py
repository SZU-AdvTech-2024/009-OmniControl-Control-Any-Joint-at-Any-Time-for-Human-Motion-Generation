...
def collate(batch):
    ...
    #TODO:step 1.2.添加detailed_text项，和t2m_collate函数中的detailed_text项对应 
...
def t2m_collate(batch):
    adapted_batch = [{
        ...
        'lengths': b[5],
        # 'hint': b[-1],
        'detailed_text': b[-1]   # TODO:step 1.1.添加字典key——detailed text，用作保存细粒度文本的内容，可以替换原有的control signal hint
    } for b in batch]
